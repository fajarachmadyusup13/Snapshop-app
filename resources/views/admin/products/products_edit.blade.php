                ...
                <div class="x_content">
                    ...
                    <form method="post" action="{{ route('products.update', ['id' => $product->id]) }}" data-parsley-validate class="form-horizontal form-label-left">
                        ...
                        <div class="form-group{{ $errors->has('barcode') ? ' has-error' : '' }}">
                            ...
                            <input type="text" value="{{$product->barcode}}" id="barcode" name="barcode" class="form-control col-md-7 col-xs-12">
                        ...
                        <div class="form-group{{ $errors->has('stock') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" value="{{$product->stock}}" id="stock" name="stock" class="form-control col-md-7 col-xs-12">
                                @if ($errors->has('stock'))
